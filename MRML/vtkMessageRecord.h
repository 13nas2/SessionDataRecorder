/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLSessionDataRecorderNode.h,v $
...
#include "vtkSlicerSessionDataRecorderModuleMRMLExport.h"



class VTK_SLICER_SESSIONDATARECORDER_MODULE_MRML_EXPORT
